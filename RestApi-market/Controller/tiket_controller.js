...
Lampung Indonesia
*/
const Model = require("../Model/model_tiket");
...
exports.add = (data) =>
  new Promise((resolve, reject) => {
    Model.create(data)
      .then(() =>
        resolve(response.suksesResponse("Berhasil Menambah Data Tiket"))
      )
      .catch(() =>
        reject(response.errorResponse("Gagal Menambah Data Tiket"))
      );
  });
